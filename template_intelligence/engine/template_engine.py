"""
Template Intelligence Engine Service

This service manages prompt templates and provides template selection logic
for the Jr Dev Agent system. It includes intelligent template selection,
...
class TemplateEngine:
    ...
    Manages prompt templates and provides intelligent template selection logic
